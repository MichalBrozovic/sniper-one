    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        ...
        case 7:
          ...
          isMultipleColumns = document.body.classList.contains("multiple-columns-body");
          targets = void 0;
          if (isMultipleColumns) {
            // Targety specificky pro více sloupců
            targets = [".benefitBanner", ".content-wrapper:has(.benefitBanner)", ".before-carousel"];
          } else {
            // Klasický switch mezi mobilem a desktopem
            targets = isMobile ? [".benefitBanner", ".content-wrapper:has(.benefitBanner)", ".before-carousel"] : [".content-wrapper:has(.benefitBanner)", ".benefitBanner", ".before-carousel"];
          }
...
var handleWelcomeText = function handleWelcomeText() {
  if (window.shoptetPage !== "homepage") return;
  var welcomeModule = document.querySelector(".homepage-box.welcome-wrapper");
  if (!welcomeModule || welcomeModule.classList.contains("is-processed")) return;
  ...
  if (welcomeInner) {
    ...
    var wrapperIn = document.createElement("div");
    ...
    welcomeModule.classList.add("content-wrapper", "processed-welcome-section", "is-processed");
  }
  ...
  if (swapperSections.length) {
    ...
    target = document.querySelector(".product-section") || document.querySelector(".favourite-categories") || document.querySelector(".banners-row") || document.querySelector("header");
  } else {
    target = document.querySelector(".product-section") || document.querySelector(".favourite-categories") || document.querySelector(".before-carousel") || document.querySelector("header");
  }
...
var handleRelatedAndAlternativeProducts = function handleRelatedAndAlternativeProducts() {
  ...
  (_document$querySelect = document.querySelector("#productsAlternative")) === null || _document$querySelect === void 0 || _document$querySelect.remove();
...
var handleFooterUpper = function handleFooterUpper() {
  var _window$projectTransl7, _document$querySelect2, _document$querySelect3;
  var lang = window.shoptetLang || "cs";
...
var RecentlyViewed = function () {
  ...
  return {
    run: function run() {
      var excludedPages = ["id-29", "id--51", "id--7", "id--8", "id--12", "id--13", "id--18", "id--57", "id--43", "id--61", "id--62", "id--63", "id--64", "id--44", "id--45", "id--46", "id--2", "id--3"];
